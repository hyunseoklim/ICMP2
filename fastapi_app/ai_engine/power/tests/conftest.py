"""power/tests/conftest.py — 전력 도메인 테스트 공통 fixture.

수직 분리(ai-vertical-split): 전력 테스트는 power.core를 쓴다.
교차 도메인 fixture(make_gas_bundle)는 제거 — gas 의존 차단.
"""
...
from power.core.data_types import DataPoint, SensorBundle
