...
from devkit.generator.gas_generator import generate_scenario as gen_gas_scenario
from devkit.generator.power_generator import generate_scenario as gen_power_scenario

# 예측 서브시스템 (Step 2 — 미래 위험 예측 연결)
from devkit.core.enums import ForecastConfidence
from devkit.core.integration import PredictionSubsystem
