    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user_type', models.CharField(choices=[('admin', '관리자'), ('manager', '현장 관리자'), ('worker', '작업자')], default='worker', max_length=20)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('login_result', models.CharField(choices=[('success', '성공'), ('failure', '실패')], max_length=10)),
